              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@austinorigamicircle.com" className="text-gray-600 hover:text-gray-900">
                      hello@austinorigamicircle.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+15125551234" className="text-gray-600 hover:text-gray-900">
                      (512) 555-1234
                    </a>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-gray-600">Visit our studio in downtown Austin</p>
          </div>
